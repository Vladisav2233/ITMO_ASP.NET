...
namespace Lab_ASP.NET_MVC.Controllers
{
    public class MyController : Controller
    {
        ...
        /*public string Index(string he1)
        {
            //string Greeting = ModelClass.ModelHello() + ", " + he1;
            //return Greeting;
            //string res = ExeEnum();
            //return res;
        ...
        */
        ...
        public string ExeTriangle()
        {
            ...
            string sql = String.Format("Площадь фигуры {0} равна: {1:0.##}", tr1.Name, tr1.Area);
            return sql;
        }
        ...
        public string ExeCollection2()
        {
            ...
            {
                new Triangle(15, 15 ,16),
                new Triangle(10, 12 ,11),
                new Triangle(22, 16 ,17),
                new Triangle(7, 22 ,32),
            };
            Tria.Sort();
            StringBuilder str = new StringBuilder();
